export const saving_sharing_AlgosADM = {
  properties: {
    noAICont: {
      enum: ["Doorgaan"],
    },
      ...
      oneOf: [
        {
          properties: {
            ...
            impact: {
              $ref: "#/definitions/impact_AlgosADM",
            },
          },
        },
        {
                      ...
                      oneOf: [
                        {
                          properties: {
                            ...
                            additionalOutputText: {
                              default: `Let op: Het langdurig opslaan of delen met derden van de output van een algoritme kan leiden tot aanmerkelijke (onvoorziene) gevolgen voor een betrokkene. Hierdoor kan in juridische zin sprake zijn van van sADM volgens AVG artikel 22 ook wanneer het primaire gebruik van het algoritme dit niet is. Bepaal in overleg met relevante juridische experts of door opslag of delen van de uitkomsten indirect sprake kan zijn van sADM. Zie ook https://www.autoriteitpersoonsgegevens.nl/documenten/advies-geautomatiseerde-besluitvorming`,
                            },
                            outputIntermediate: {
                              type: "string",
                              title: "Volgende stap",
